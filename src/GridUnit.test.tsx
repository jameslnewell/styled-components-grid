...
describe('GridUnit', () => {
  ...
  it('should render size at different breakpoints', () => {
    const {container} = render(
      <Grid.Unit size={{mobile: 1, tablet: 0.5, desktop: 0}} />,
    );
